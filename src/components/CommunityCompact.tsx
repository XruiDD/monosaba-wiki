  ...
  return (
    <div className="community-compact">
      ...
      <div className="cc-server-mini">
        <button className="cc-srv-row" onClick={() => copy("manosaba.tlspark.cn")}>
          <span className="cc-srv-label mono">默认</span>
          <span className="cc-srv-addr mono">manosaba.tlspark.cn</span>
          <span className="cc-srv-copy mono">{copied === "manosaba.tlspark.cn" ? "✓" : "⎘"}</span>
        </button>
      </div>
    </div>
  );
