...
export default function LicenseModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  useEffect(() => {
    if (!open) return;
    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal license-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <ul className="lic-list">
          ...
          <li>✗ 复制 <span className="mono">public/assets/</span>、<span className="mono">public/data/</span> 等内容作独立分发</li>
          <li>✗ 任何商业/营利用途</li>
        </ul>
        ...
        <p className="serif" style={{fontSize: 14, lineHeight: 1.9, color: "var(--ink-dim)"}}>
          ...
          Minecraft 是 Mojang AB 的注册商标。配方所用原版材质取自 Mojang 官方 1.21.9 客户端。
        </p>
