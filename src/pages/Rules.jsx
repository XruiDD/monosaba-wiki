    ...
    <div>
      ...
      <div className="loop-flow">
        {[
          ...
          {k: "02", t: "确认死亡",   d: "某具遗体被调查后，启动『调查阶段』—— 4 分钟"},
          {k: "03", t: "魔女审判",   d: "所有存活玩家被传唤至审判庭，开始魔女审判"},
          {k: "04", t: "投票与处刑", d: "累积两轮最高得票者将被处刑 / 超时则全员受到惩罚"},
      ...
      <div className="attrs-grid">
        {[
          {n: "意志力",  en: "WILLPOWER", d: "当意志力低于 50% 有概率触发『杀意转化』，即预备魔女可能转化为『杀意魔女』。且意志力越低，转化概率越高。"},
          {n: "魔力 MP", en: "MANA",      d: "施法需要消耗魔力值。低于 100 时每秒回复4点，自然恢复上限为 100，累积上无封顶。"},
          {n: "压力值",  en: "PRESSURE",  d: "会因为玩家行为发生改变。玩家受到伤害，任务失败，使用特殊道具等行为均会对压力值产生影响。"},
          {n: "越狱进度",en: "BREAKOUT",  d: "通过完成任务累积。达到 100% 即可判定『预备魔女』胜利。"},
        ].map((a) => (
