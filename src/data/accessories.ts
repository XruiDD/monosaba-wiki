...
export type TeamId = "green" | "orange" | "pink" | "yellow";
...
export interface ComboRecord {
  tier: "main" | "minor" | "easter";
  members: string[];
  name: string;
  effect: string;
}

export const TEAM: Record<TeamId, string> = {
  green:  "#50f77a",
  orange: "#ffd085",
  pink:   "#ffd0f6",
  yellow: "#ffff85",
...
export const ACC_DATA: AccessoryRecord[] = [
  // —— 绿队 ——
...
// 联动效果
export const COMBO_DATA: ComboRecord[] = [
  // 强联动
